...
public class ReflectDemo {
	public static void main(String[] args) throws Exception {
		// 加载类
		Class<?> class0 = ReflectDemo.class.getClassLoader().loadClass("com.my.study.demos.reflect.Person");
		Class<?> class1 = Class.forName("com.my.study.demos.reflect.Person1");
		Class<?> class11 = Class.forName("com.my.study.demos.reflect.Person");
